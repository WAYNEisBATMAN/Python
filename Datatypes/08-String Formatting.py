...
""" formatting means arrange or put into a format. 
    Python uses c style string 
    formatting to create new, formatted strings. The '%'(modulo) operator is used to format
    a set of variables enclosed in a "tuple"(a fixed size list), together with a format string 
    which contains normal text together with "argument/format specifiers", 
    special symbols for different data types like "%s","%d","%f" for string,integer,float
