...
"""
------------------------------------------------Different types of pattern problems--------------------------------------------------------
...
There is a typical structure to print any pattern, i.e. the number of rows and columns in the pattern. 
Outer loop tells us the number of rows used and the inner loop tells us the column used to print pattern.
